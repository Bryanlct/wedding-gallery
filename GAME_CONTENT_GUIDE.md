...
1. 連連看 + 約會路線：配對四組回憶後，依序點出散步 → 鐘樓 → 燈火 → 甜品
2. 翻牌記憶 + 日期節奏：配對四組牌後，依序點出 `1 2 0 6`
3. 婚禮佈置：把六件物品放到正確會場格子，雨傘與行李箱是多餘的
4. 告白填詞：把相遇 / 光 / 四季 / 同行填入空格，再長按送出
...
- `garden-bright.png`：第三章花園背景
- `ending.png`：通關結局 CG

替換時保留檔名即可。建議使用 9:16 直向圖片，寬度至少 1080px。
